        ...
        <div className="space-y-8 lg:col-span-2">
          ...
          <GlassCard className="p-8 border-slate-200/80 bg-white/70 shadow-sm">
            <div className="flex items-center gap-3 mb-8">
              ...
              <div>
                <h3 className="text-sm font-black text-slate-800 uppercase tracking-widest">Model Tuning Sandbox</h3>
                <p className="text-[10px] text-slate-400 uppercase font-mono tracking-wider mt-0.5">Parameters drive inference outputs</p>
              </div>
            </div>
          ...
          <GlassCard className="p-8 border-slate-200/80 bg-white/70 shadow-sm">
            <div className="flex items-center gap-3 mb-8">
              ...
              <div>
                <h3 className="text-sm font-black text-slate-800 uppercase tracking-widest">Active Tone Profile</h3>
              ...
              {personas.map((persona) => {
                ...
                return (
                  ...
                  >
                    ...
                    <div>
                      <h4 className="text-xs font-black text-slate-800 uppercase tracking-wide mb-1">{persona.title}</h4>
                      <p className="text-[9px] text-slate-500 leading-relaxed font-semibold">{persona.desc}</p>
                    </div>
                  </motion.button>
                );
              })}
        ...
        <div className="space-y-8">
          ...
          <GlassCard className="p-8 border-slate-200/80 bg-white/70 shadow-sm">
            <div className="flex items-center gap-3 mb-8">
              ...
              <div>
                <h3 className="text-sm font-black text-slate-800 uppercase tracking-widest">Safety Policy Firewall</h3>
                <p className="text-[10px] text-slate-400 uppercase font-mono tracking-wider mt-0.5">Real-time policing boundaries</p>
              </div>
            </div>
            ...
            <div className="space-y-6">
              ...
              <div className="flex justify-between items-center py-2.5 border-b border-slate-200">
                <div>
                  <h4 className="text-xs font-bold text-slate-800 uppercase">Hallucination Policing</h4>
                  <p className="text-[8px] text-slate-400 uppercase mt-0.5">Validates responses against vectors</p>
                </div>
                <button 
                  onClick={() => setPolicingActive(!policingActive)}
                  className={`w-12 h-6 rounded-full p-1 transition-all ${policingActive ? 'bg-emerald-500' : 'bg-slate-200'}`}
                >
                  <motion.div 
                    layout 
              ...
              <div className="flex justify-between items-center py-2.5 border-b border-slate-200">
                <div>
                  <h4 className="text-xs font-bold text-slate-800 uppercase">Tonal Compliance Guard</h4>
                  <p className="text-[8px] text-slate-400 uppercase mt-0.5">Flags passive-aggression</p>
                </div>
                <button 
                  onClick={() => setEthicsFilter(!ethicsFilter)}
                  className={`w-12 h-6 rounded-full p-1 transition-all ${ethicsFilter ? 'bg-emerald-500' : 'bg-slate-200'}`}
                >
                  <motion.div 
                    layout 
                    className="w-4 h-4 bg-white rounded-full shadow-sm" 
              ...
              <div className="space-y-2.5 pt-2">
                <div className="flex justify-between text-[10px] font-bold text-slate-500 uppercase">
                  ...
                  <span className="font-mono text-emerald-600 font-bold">{escalationThreshold}%</span>
                </div>
                <input 
                  type="range" 
                  min="50" 
          ...
          <GlassCard className="p-8 border-slate-200/80 bg-white/70 shadow-sm">
            <div className="flex items-center gap-3 mb-8">
              ...
              <div>
                <h3 className="text-sm font-black text-slate-800 uppercase tracking-widest">Vector Core Link</h3>
            ...
            <div className="space-y-6">
              ...
              {dbLogs.length > 0 && (
                <div className="p-4 rounded-xl bg-slate-50 border border-slate-200 font-mono text-[9px] text-slate-700 space-y-1.5 h-28 overflow-y-auto">
                  {dbLogs.map((log, i) => (
              ...
              <button 
                ...
                className="w-full py-3.5 bg-gradient-premium text-white rounded-xl text-xs font-black uppercase tracking-widest shadow-md hover:brightness-110 active:scale-[0.98] transition-all flex justify-center items-center gap-2.5"
              >
                {dbStatus === 'Testing' ? (
                  <>
